...
export default class ItemList extends Component {
  ...
  render() {
    if (
      !(this.props.currentChannelItems instanceof Array) ||
      this.props.currentChannelItems.length === 0
    ) {
      debug(
        "Rendering disabled: no current items",
        this.props.currentChannelItems
      );
      return null;
    }

    debug(
      "Rendering with current items",
      typeof this.props.currentChannelItems,
      this.props.currentChannelItems
    );
    ...
    const title = this.props.currentChannelId ? (
      <h2>{this.props.currentChannelId}</h2>
    ) : null;
